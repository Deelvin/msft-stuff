...
class TreeliteModel(utils.benchmark_base.ModelBase):
    def __init__(self, model_path: str, input_dict: typing.Dict[str, numpy.ndarray]):
        print(f"TreeliteModel: {model_path}")
        self._engine = utils.load.load_treelite(model_path)
    ...
    def get_inference_function(self, inputs: typing.Dict[str, numpy.ndarray]):
        runner = utils.inference.treelite_inference_runner(self._engine)
